...
VRSemanticWidget::VRSemanticWidget(VRGuiSemantics* m, string color) : VRCanvasWidget() {
    manager = m;
...
void VRSemanticWidget::setPropRow(string name, string type, string color, int flag, int ID, int rtype) {
