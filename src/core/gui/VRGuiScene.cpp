...
VRGuiScene::VRGuiScene() { // TODO: reduce callbacks with templated functions
    ...
    connect_signal<void, GdkDragContext*, int, int, GtkSelectionData*, guint, guint>((GtkWidget*)tree_view, bind(&VRGuiScene::on_drag_data_receive, this, placeholders::_1, placeholders::_2, placeholders::_3, placeholders::_4, placeholders::_5, placeholders::_6), "drag_data" );
