 ...
 */
#ifdef _WINDOWS
GTK_GL_VAR extern const guint gtkglext_major_version;
GTK_GL_VAR extern const guint gtkglext_minor_version;
GTK_GL_VAR extern const guint gtkglext_micro_version;
GTK_GL_VAR extern const guint gtkglext_interface_age;
GTK_GL_VAR extern const guint gtkglext_binary_age;
#else
