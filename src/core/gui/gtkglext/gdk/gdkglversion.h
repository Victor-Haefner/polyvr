 ...
 */
#ifdef _WINDOWS
GDK_GL_VAR extern const guint gdkglext_major_version;
GDK_GL_VAR extern const guint gdkglext_minor_version;
GDK_GL_VAR extern const guint gdkglext_micro_version;
GDK_GL_VAR extern const guint gdkglext_interface_age;
GDK_GL_VAR extern const guint gdkglext_binary_age;
#else
