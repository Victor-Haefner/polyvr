...
VRGeometryPtr VRConstructionKit::addObjectAnchor(VRTransformPtr t, int a, PosePtr pose, float radius) {
    ...
    snapping->addRule(VRSnappingEngine::POINT, VRSnappingEngine::POINT, Pose::create(), Pose::create(Vec3d(), pose->dir(), pose->up()), radius, 0, t );
    return anc;
}
