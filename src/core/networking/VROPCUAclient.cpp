...
EndpointDescription UaClient::SelectEndpoint(const std::string & endpoint)
{
  ...
  cout << "Error in SelectEndpoint, No supported endpoints found on server" << endl;
...
{
  if (!Server) { cout << "Error in GetServerNamespaces, Not connected" << endl; return {""}; }
...
{
  if (!Server) { cout << "Error in GetNamespaceIndex, Not connected" << endl; return -1; }
  ...
  cout << "Error namespace uri does not exists in server" << endl;
  return -1;
}
...
{
  if (!Server) { cout << "Error in GetNode, Not connected" << endl; return Node(); }
...
{
  if (!Server) { cout << "Error in GetRootNode, Not connected" << endl; return Node(); }
...
{
  if (!Server) { cout << "Error in GetObjectsNode, Not connected" << endl; return Node(); }
...
{
  if (!Server) { cout << "Error in GetServerNode, Not connected" << endl; return Node(); }
