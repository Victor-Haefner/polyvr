#ifndef RPCUTILS_H_INCLUDED
#define RPCUTILS_H_INCLUDED


#define FACETESSDATA_Polyface                          0x0001
#define FACETESSDATA_Triangle                          0x0002
#define FACETESSDATA_TriangleFan                       0x0004
#define FACETESSDATA_TriangleStripe                    0x0008
#define FACETESSDATA_PolyfaceOneNormal                 0x0010
#define FACETESSDATA_TriangleOneNormal                 0x0020
#define FACETESSDATA_TriangleFanOneNormal              0x0040
#define FACETESSDATA_TriangleStripeOneNormal           0x0080
#define FACETESSDATA_PolyfaceTextured                  0x0100
#define FACETESSDATA_TriangleTextured                  0x0200
#define FACETESSDATA_TriangleFanTextured               0x0400
#define FACETESSDATA_TriangleStripeTextured            0x0800
#define FACETESSDATA_PolyfaceOneNormalTextured         0x1000
#define FACETESSDATA_TriangleOneNormalTextured         0x2000
#define FACETESSDATA_TriangleFanOneNormalTextured      0x4000
#define FACETESSDATA_TriangleStripeOneNormalTextured   0x8000
#define FACETESSDATA_NORMAL_Single   		0x40000000
#define FACETESSDATA_NORMAL_Mask			0x3FFFFFFF
#define FACETESSDATA_WIRE_IsNotDrawn		0x4000		// Indicates that the edge should not be drawn (its neighbor will be drawn).
...
typedef struct {
    short Type; // Value type (VT_double or VT_exponent)
    short NumberOfBits;
    unsigned Bits;
    union {
...
static int stCOFDOECompare(const void* pcofdoe1,const void* pcofdoe2) {
	return(EXPONENT(((const sCodageOfFrequentDoubleOrExponent *)pcofdoe1)->u2uod.Value)-EXPONENT(((const sCodageOfFrequentDoubleOrExponent *)pcofdoe2)->u2uod.Value));
}
