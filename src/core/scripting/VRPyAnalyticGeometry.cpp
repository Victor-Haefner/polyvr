...
PyMethodDef VRPyAnalyticGeometry::methods[] = {
    {"setVector", PyWrap(AnalyticGeometry, setVector, "Add/set an annotated vector", void, int, Vec3d, Vec3d, Color3f, string) },
    {"setCircle", PyWrap(AnalyticGeometry, setCircle, "Add/set an annotated circle", void, int, Vec3d, Vec3d, float, Color3f, string) },
