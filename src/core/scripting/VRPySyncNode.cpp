...
PyMethodDef VRPySyncNode::methods[] = {
    ...
    {"addRemoteAvatar", PyWrap(SyncNode, addRemoteAvatar, "Add avatar components, a geometry for the head, another for the hand, and a transform attached to the hand for DnD", void, VRTransformPtr, VRTransformPtr, VRTransformPtr) },
