...
PyMethodDef VRPyGeometry::methods[] = {
    ...
    {"split", PyWrap( Geometry, split, "Split geometry in N parts", vector<VRGeometryPtr>, int ) },
    ...
    {"getMeshVisibility", PyWrap(Geometry, getMeshVisibility, "Get mesh visibility", bool) },
