...
PyMethodDef VRPyMQTTClient::methods[] = {
    ...
    {"setCertificates", PyWrap(MQTTClient, setCertificates, "Set TLS certificates (ca.pem, cert.pem, key.pem)", void, string, string, string) },
    ...
    {"publish", PyWrapOpt(MQTTClient, publish, "Publish a topic (topic, message, retain)", "0", void, string, string, bool) },
    {NULL}  /* Sentinel */
};
