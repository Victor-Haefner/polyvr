...
PyMethodDef VRPyObject::methods[] = {
    ...
    {"find", PyWrap(Object, find, "Find node with given name in scene graph below this node", VRObjectPtr, string) },
    ...
    {"setPickable", PyWrapOpt(Object, setPickable, "Set if the object is pickable - setPickable(int pickable)\n   pickable can be 0 or 1 to disable or enable picking, as well as -1 to block picking even if an ancestor is pickable", "0", void, int, bool) },
