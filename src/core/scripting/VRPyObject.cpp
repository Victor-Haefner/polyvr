...
PyMethodDef VRPyObject::methods[] = {
    ...
    {"setEntity", PyWrap(Object, setEntity, void, (VREntityPtr)), "Set entity - setEntity( Entity )" },
    {"getEntity", PyWrap(Object, getEntity, VREntityPtr, ()), "Get entity - Entity getEntity()" },
