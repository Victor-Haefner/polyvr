...
PyMethodDef VRPyPointCloud::methods[] = {
    ...
    {"externalColorize", PyWrap( PointCloud, externalColorize, "External algorithm to colorize a pointcloud from panorama images, use the extras/utils/extractEXIF.sh script and give the path to the resulting dat file as second argument", void, string, string, float, float, float, int, int) },
