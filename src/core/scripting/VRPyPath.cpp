...
PyMethodDef VRPyPath::methods[] = {
    ...
    {"setPoint", PyWrapOpt2(Path, setPoint, "Set ith point ( i, Pose pose | vec3 color)", "1 1 1", void, int, const Pose & p, Color3f ) },
    ...
    {"getPoint", PyWrap2(Path, getPoint, "Return the pose of point i - pose getPoint( int i )", Pose&, int ) },
