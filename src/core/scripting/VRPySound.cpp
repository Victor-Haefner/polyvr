...
PyMethodDef VRPySound::methods[] = {
    ...
    {"synthSpectrum", (PyCFunction)VRPySound::synthSpectrum, METH_VARARGS, "synthSpectrum( [A], int S, float T, float F, bool retBuffer )\t\n A amplitude, S sample rate, T packet duration in seconds, F fade in/out as proportion of duration from 0 to 1, specify if you want to return the generated buffer" },
