...
PyMethodDef VRPyTransform::methods[] = {
    ...
    {"setPoseTo", PyWrap(Transform, setPoseTo, "Set the object's pose in coord system of other (pose, other)", void, PosePtr, VRObjectPtr ) },
    ...
    {"attach", PyWrapOpt(Transform, attach, "Attach another object using a joint constraint and a spring constraint (other, joint, spring, disableCollisions)", "0|1", void, VRTransformPtr, VRConstraintPtr, VRConstraintPtr, bool ) },
    {"detachJoint", PyWrap(Transform, detachJoint, "Remove all joints to given transform created by 'attach'", void, VRTransformPtr ) },
    {"setSpringParameters", PyWrap(Transform, setSpringParameters, "Set joint spring parameters (other, dof, stiffness, damping)", void, VRTransformPtr, int, float, float ) },
    {"setSpringEquilibrium", PyWrap(Transform, setSpringEquilibrium, "Set joint spring equilibrium (other, dof, equilibrium)", void, VRTransformPtr, int, float ) },
    ...
    {"drag", PyWrapOpt(Transform, drag, "Drag this object by new parent", "0", void, VRTransformPtr, VRIntersectionPtr ) },
    ...
    {"castRay", PyWrap(Transform, intersect, "Cast a ray and return the intersection with given subtree", VRIntersectionPtr, VRObjectPtr, Vec3d ) },
    ...
    {"setFriction", PyWrap(Transform, setFriction, "Set the friction of the physics object", void, float ) },
    {"getMass", PyWrap(Transform, getMass, "Get physics mass", float ) },
    {"getFriction", PyWrap(Transform, getFriction, "Get physics friction", float ) },
    {"getInertiaMoment", PyWrap(Transform, getInertiaMoment, "Get physics inertia moment", PosePtr ) },
    ...
    {"getAcceleration", PyWrap(Transform, getAcceleration, "get the acceleration", Vec3d ) },
    {"getAngularAcceleration", PyWrap(Transform, getAngularAcceleration, "get the angular acceleration", Vec3d ) },
