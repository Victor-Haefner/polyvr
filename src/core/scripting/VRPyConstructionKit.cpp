...
PyMethodDef VRPyConstructionKit::methods[] = {
    ...
    {"addObjectAnchor", PyWrap( ConstructionKit, addObjectAnchor, "Add anchor to object - addObjectAnchor(obj, int anchor, position, flt radius)", VRGeometryPtr, VRTransformPtr, int, PosePtr, float ) },
