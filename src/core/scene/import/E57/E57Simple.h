...
//	e57::Quaterniond
//
//! @brief The e57::Quaterniond is a quaternion which represents a rigid body rotation.
...
public:
	e57::Quaterniond		rotation;		//!< A unit quaternion representing the rotation, R, of the transform
