...
class VRSyncChangelist {
    ...
    public:
        ...
        string serialize(VRSyncNodePtr syncNode, ChangeList* clist, size_t& counter1, size_t& counter2, size_t limit = 0);
        ...
        void deserializeAndApply(VRSyncNodePtr syncNode);
