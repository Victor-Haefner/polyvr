...
{
  /* allocate && initialize list of Vertices in VRPolygon */
  ...
  /* we want a counter-clockwise VRPolygon in V */
  ...
  {
    /* if we loop, it is probably a non-simple VRPolygon */
    if (0 >= (count--))
    {
      //** Triangulate: ERROR - probable bad VRPolygon!
      return false;
    }

    /* three consecutive vertices in current VRPolygon, <u,v,w> */
    ...
    if ( Snip(contour,u,v,w,nv,V) )
    {
      ...
      /* remove v from remaining VRPolygon */
