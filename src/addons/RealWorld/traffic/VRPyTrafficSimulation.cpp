...
PyMethodDef VRPyOldTrafficSimulation::methods[] = {
    ...
    {"setServer", (PyCFunction)VRPyOldTrafficSimulation::setServer, METH_VARARGS, "Sets the server name && port" },
...
PyObject* VRPyOldTrafficSimulation::setServer(VRPyOldTrafficSimulation* self, PyObject* args) {
