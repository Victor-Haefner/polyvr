...
PyMethodDef VRPyProcess::methods[] = {
    ...
    {"getMessages", PyWrap(Process, getMessages, "Return messages - [ProcessNode] getSubjects()", vector<VRProcessNodePtr> ) },
    {"getSubjectMessages", PyWrap(Process, getSubjectMessages, "Return subject messages - [ProcessNode] getSubjects()", vector<VRProcessNodePtr>, int ) },
    {"getMessageSubjects", PyWrap(Process, getMessageSubjects, "Return message subjects - [ProcessNode] getSubjects()", vector<VRProcessNodePtr>, int ) },
