...
PyMethodDef VRPyRobotArm::methods[] = {
    ...
    {"moveTo", PyWrapOpt(RobotArm, moveTo, "Move the end effector to a certain position, optionally in local robot coords, default in world coords - moveTo(pose | local)", "0", void, PosePtr, bool ) },
