...
PyMethodDef VRPyPipeSystem::methods[] = {
    ...
    {"getValveState", PyWrap( PipeSystem, getValveState, "Get valve state", double, string ) },
    ...
    {"getPump", PyWrap( PipeSystem, getPump, "Get pump head gain [m]", double, string ) },
    {"setPump", PyWrap( PipeSystem, setPump, "Set pump head gain [m] and isOpen props", void, string, double, bool ) },
    {"setValve", PyWrap( PipeSystem, setValve, "Set valve state", void, string, double ) },
...
PyMethodDef VRPyRobotArm::methods[] = {
    ...
    {"getSpeed", PyWrap(RobotArm, getSpeed, "Get path follow animation speed", float ) },
