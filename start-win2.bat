...
set PYTHONPATH=%PYTHONPATH%;C:\usr\vcpkg\installed\x64-windows\tools\python3\Lib
set PYTHONPATH=%PYTHONPATH%;D:\usr\vcpkg\installed\x64-windows\tools\python3\Lib
set DISPLAY=
