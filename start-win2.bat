...
set PATH=%PATH%;D:\Program Files (x86)\Windows Kits\10\Redist\ucrt\DLLs\x64;D:\usr\lib\opensg;D:\usr\lib\collada;D:\usr\vcpkg\installed\x64-windows\lib;D:\usr\lib\cef;D:\usr\lib\oce;D:\usr\lib\ifc;
